...
\newcommand{\coverpage}[1]{%
	\pagenumbering{roman}%
	\thispagestyle{empty}%
	\lhead{\textsc{\small{Trabajo Final:} #1}}%
    \title{Especialización en Sistemas Embebidos}%
    \author{Autor: Leandro Marsó,
    \\
            Profesores: Mario Beron, Martín Murdocca, Alejandro Nuñez Manquez}%
	...
	\rulebreak%
    {\Large\textbf{Arquitectura y Programación de Sistmas Embebidos}}
